...
; Generate a map file (debugging) for use with Cspect
        CSPECTMAP "game/output/DougieDo.map"
...
; AY Chip-3 - 3 x Channels - AYFX - Sound Effects
...
.Audio
        call    NextDAW_UpdateSong              ; Keep NextDAW song playing - TODO
        ld      a, %1'11'111'01                 ; AYFX - Change selected chip to AY-3
        ld      bc, $fffd
        out     (c), a
        call    AFXFrame                       ; Keep AYFX sound effect playing - TODO
	...
	;out (#fe),a   ; set the border color
        ...
        include "game/palettes.asm"
        include "game/sprites.asm"
        include "game/tilemaps.asm"
        include "game/routines.asm"
        include "game/collision.asm"
        include "game/input.asm"
        include "game/rock.asm"
        include "game/FillFlood.asm"
        include "game/enemy.asm"
        include "game/hud.asm"
        include "game/LevelManager.asm"
...
; and the initial stack pointer.
        SAVENEX OPEN "Game/output/DougieDo.nex", Start, stack_top, 0, 2 ; V1.2 enforced
